...
public class CmdChironJob extends Command {
	...
	protected void execute(CommandEvent event) {
		...
		//try {
		//	json = JsonParser
		//			.parseString(GeekBot.get(GeekBot.getCHIRON_URL() + "/job?apikey=" + GeekBot.getCHIRON_KEY()))
		//			.getAsJsonObject();
		...
		event.getChannel().sendMessage(PrinterUtilities.PrinterJob(event, Printer.CHIRION).build()).submit();
	}
