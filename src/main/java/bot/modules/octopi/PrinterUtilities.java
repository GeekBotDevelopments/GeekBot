...
public class PrinterUtilities
{
    ...
    public static EmbedCreateSpec createPrinterOutput(PrinterEnum printer)
    {
        ...
        try
        {
            json = JsonParser.parseString(RestUtil.getString(printer.getUrl() + "/api/job?apikey=" + printer.getKey()))
                    .getAsJsonObject();
